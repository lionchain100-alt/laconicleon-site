---
title: How to Use a Tip Calculator With Tax and Split a Bill
slug: tip-calculator-tax-split-bill-guide
author: Leon Reed
description: A practical tip calculator walkthrough for adding restaurant tax
...
- Subtotal: `$80.00`
- Receipt tax: `$8.00`
- Amount after tax, before tip: `$88.00`
...
- `$16.00 ÷ $80.00 = 20%` before tax
- `$16.00 ÷ $88.00 ≈ 18.18%` after tax
...
1. The subtotal matches the receipt.
2. The tax is entered as printed or calculated using the correct local rate.
3. The tip percentage uses the intended before-tax or after-tax basis.
4. Any service charge or discount is accounted for once.
5. The completed total is calculated before splitting.
6. All payer shares add back to the completed total.

You can run this workflow with the [Calculator Toolkit tip calculator](https://calculator-toolkit.com/). It performs bill calculations locally in the browser and does not require an account. Results are estimates and do not replace the printed receipt, restaurant policy, or local tax rules.
